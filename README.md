...
**[`docs/RESULTS.md`](docs/RESULTS.md)** — structured scorecard (auto-generated by
`scripts/results_table.py`). Headline: on the multi-task average TRINITY (0.750) beats every single
fixed model (best 0.639) and random routing (0.558) — R1/R2/R4 hold, with honest caveats on seed
variance and eval noise. Cost tracked via `scripts/cost_report.py`.
