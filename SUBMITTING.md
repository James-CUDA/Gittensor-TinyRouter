...
artifact SHA-256 manifest, CMA-ES receipt metadata, and fitness-history
sequence audit. Three **advisories** (SVF training-signal, ledger call
volume, head routing diversity) may print warnings but never block submission.
